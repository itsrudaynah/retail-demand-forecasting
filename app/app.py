...
historical = pd.read_csv(BASE_DIR / "data/processed/clean_sample.csv", parse_dates=["date"])
validation = pd.read_csv(BASE_DIR / "outputs/forecasts/validation_results.csv", parse_dates=["date"])
forecast = pd.read_csv(BASE_DIR / "outputs/forecasts/forward_forecast_15d.csv", parse_dates=["date"])
# Header
